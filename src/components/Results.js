          ...
          <Row style={{ width: "100%" }} gutter={[32, 32]}>
            <Col md={{ span: 12, offset: 6 }} xs={{ span: 24 }}>
              <Card>
                ...
                <LanguagesChart
                  data={answers.find(
                    (i) => i.title === "What is your favorite language?"
                  )}
                />
              </Card>
            </Col>
            <Col md={{ span: 12 }} xs={{ span: 24 }}>
              <Card>
                <h2>What is your favorite database?</h2>
                <PieChart
                  data={answers.find(
                    (i) => i.title === "What is your favorite database?"
                  )}
                />
              </Card>
            </Col>
            <Col md={{ span: 12 }} xs={{ span: 24 }}>
              <Card>
                <h2>What is your favorite dish?</h2>
                <PieChart
                  data={answers.find(
                    (i) => i.title === "What is your favorite dish?"
                  )}
                />
              </Card>
            </Col>
